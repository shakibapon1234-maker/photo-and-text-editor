...
4. §৮.২ — টেক্সটের পাশাপাশি একটা "3D ইমেজ" অপশন যোগ করা (এখনো ইমপ্লিমেন্ট করা হয়নি, প্ল্যান §৮.২-এ ডিজাইন আছে)।
...
**অনুরোধ:** টেক্সটের পাশাপাশি একটা ছবি (ইমেজ ফাইল) আপলোড/ইমপোর্ট করার অপশন — যেটাকেও টেক্সটের মতোই ৩ডি অবজেক্ট হিসেবে ট্রিট করা যাবে: depth/extrude, rotate/tilt, ম্যাটেরিয়াল, এবং বিদ্যমান ১৭টা প্রিসেট অ্যানিমেশন (Fade In, Pop In, Rotate In ইত্যাদি) দিয়ে থ্রিডি মুভ/অ্যানিমেট করা যাবে — ঠিক টেক্সটের মতোই।

**প্রস্তাবিত হাই-লেভেল ডিজাইন:**
- ইনপুট প্যানেলে টেক্সট ইনপুটের পাশে একটা "ছবি আপলোড করুন" অপশন যোগ হবে।
- আপলোড করা ছবিকে টেক্সচার হিসেবে একটা extruded plane-এ (সাইড-থিকনেসসহ একটা "থ্রিডি ফটো কার্ড"-এর মতো মেশ) বসানো হবে, যাতে বিদ্যমান Depth স্লাইডার এখানেও কাজ করে।
- বর্তমান Rotate/Tilt, Material (Matte/Glossy/Metallic/Glass/Neon), Lighting, এবং Animation প্যানেল — এই সবকটাই টেক্সট মেশের বদলে ইমেজ-মেশেও reuse করা হবে (আর্কিটেকচারে "বর্তমানে অ্যাক্টিভ অবজেক্ট" ধারণাটা টেক্সট বা ইমেজ — দুটোর জন্যই এক থাকবে)।
- Export pipeline (WebM/PNG sequence) অপরিবর্তিত থাকবে, কারণ এটা পুরো scene ক্যাপচার করে — অবজেক্টটা টেক্সট না ইমেজ, তা নিয়ে কোনো ফারাক করে না।

**যা যাচাই করা লাগবে (পরবর্তী সেশনে):**
- টেক্সট ও ইমেজ — দুটো কি একই সাথে scene-এ রাখা যাবে, নাকি একবারে যেকোনো একটা (টেক্সট বা ইমেজ)?
- ছবির resolution/aspect-ratio অনুযায়ী plane-এর সাইজ/অনুপাত কীভাবে ঠিক হবে।
- বড় সাইজের ছবিতে পারফরম্যান্স — polygon count না বাড়লেও টেক্সচার সাইজ বড় থাকলে GPU মেমোরি/লোড-টাইমে প্রভাব পড়তে পারে, তাই Quality preset (Low/Medium/High)-এ টেক্সচার-রিসাইজ লজিকও যোগ করা লাগতে পারে।

**Milestone (লক্ষ্য):** ব্যবহারকারী একটা ছবি আপলোড করে সেটাকে টেক্সটের মতোই থ্রিডি রোটেট/অ্যানিমেট করে transparent ভিডিও/PNG সিকোয়েন্স হিসেবে এক্সপোর্ট করতে পারবে।
